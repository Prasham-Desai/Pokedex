document.getElementById('searchBar').addEventListener('keyup', function(event) {
    if (event.keyCode==13)
    {
        ...
        var number = document.getElementsByClassName('poke-num');
        ...
        for (var pokemon in kantoPokemon)
        {
            if(pokemon.toLowerCase()===searchTerm)
            {
                var pokeNum = kantoPokemon[pokemon];
                var pokeNumStrRaw=pokeNum.toString();
                var pokeNumStr='';
                if(pokeNum<10)
                {
                    pokeNumStr="00"+pokeNumStrRaw+".html";
                }
                else if(pokeNum>=10 && pokeNum<100)
                {
                    pokeNumStr="0"+pokeNumStrRaw+".html";
                }    
                else
                {
